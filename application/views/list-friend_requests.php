            ...
            <div class="box-body">
                ...
                <tbody class="row">
                  ...
                  foreach ($friendRequests as $key => $friendRequest) {
                    ...
                    <td class="col-lg-4">
                      <a href="<?php echo base_url(). "index.php/friend/acceptRequest?nickname=" . $nickname; ?>" class="btn btn-primary btn-block" style="width: 240px;"><b>Accepter la demande d'amitié</b></a>
                    </td>
                    <?php
                  }
                   ?>
