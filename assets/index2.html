...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url()."assets/"; ?>index2.html" class="logo">e
        ...
        <div class="col-md-8">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-danger">
                ...
                <div class="box-footer text-center">
                  <a href="<?php echo base_url()."assets/"; ?>javascript:void(0)" class="uppercase">View All Users</a>
                </div>
                <!-- /.box-footer -->
              </div>
              <!--/.box -->
          ...
          <div class="box box-info">
            ...
            <div class="box-footer clearfix">
              <a href="<?php echo base_url()."assets/"; ?>javascript:void(0)" class="btn btn-sm btn-info btn-flat pull-left">Place New Order</a>
              <a href="<?php echo base_url()."assets/"; ?>javascript:void(0)" class="btn btn-sm btn-default btn-flat pull-right">View All Orders</a>
            </div>
            <!-- /.box-footer -->
          </div>
          <!-- /.box -->
          ...
          <div class="box box-default">
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-pills nav-stacked">
                <li><a href="<?php echo base_url()."assets/"; ?>#">United States of America
                  <span class="pull-right text-red"><i class="fa fa-angle-down"></i> 12%</span></a></li>
                <li><a href="<?php echo base_url()."assets/"; ?>#">India <span class="pull-right text-green"><i class="fa fa-angle-up"></i> 4%</span></a>
                </li>
                <li><a href="<?php echo base_url()."assets/"; ?>#">China
            ...
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                ...
                <li class="item">
                  ...
                  <div class="product-info">
                    <a href="<?php echo base_url()."assets/"; ?>javascript:void(0)" class="product-title">Xbox One <span
